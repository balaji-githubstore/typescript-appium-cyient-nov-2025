...
async function invalidLoginTest() {
    ...
    await driver.$('android=new UiSelector().textContains("e-mail address")').setValue("hello@gmail.com")

    //enter password as welcom123
    await driver.$("//android.widget.EditText[@text='Password']").setValue("welomce123");

    //click on login
    await driver.$('android=new UiSelector().text("Sign in").instance(1)').click()
    ...
    //resource-id
    // await driver.$("id=com.hmil.myhyundai:id/ivNotification").click()
